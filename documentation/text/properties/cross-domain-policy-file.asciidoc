...
This is a global property that can also be overidden by configuring connection managers [ c2s, s2s, ws2s, bosh, ext, etc] and they may all have thier own policies.
