...
Virtual hosts should be managed using ad-hoc commands, visit xref:ad-hocCommands[Specification for ad-hoc Commands Used to Manage Virtual Domains] for more information.
