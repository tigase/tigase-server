...
:author: Eric Dziewa
:version: v1.0, January 2015: Reformatted for v7.2.0.
...
The Advanced configuration page. Select what components and configurations you need.  Some may be hilighted red to indicate conflicts or unmet requirements.
