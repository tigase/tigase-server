...
Tigase Server can support anonymous logins VIA SASL-ANONYMOUS in certain scenarios.  This can be enabled by using the following setting in config.tdsl file: _'vhost-anonymous-enabled' = true_
