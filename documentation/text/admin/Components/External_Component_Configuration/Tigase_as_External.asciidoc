...
image:images/adminui_extman_add_item_form.png[]
...
image:images/adminui_extman_add_item_form_external_muc.png[]
...
To make this new instance connect to the Tigase XMPP Server, you need to create one more file with external connection configuration which will be loaded to the local database and then removed.
