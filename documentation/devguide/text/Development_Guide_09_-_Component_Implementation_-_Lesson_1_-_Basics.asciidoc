...
Method *String[] getFeatures()* returns array of `String` items which are used to generate a list of features supported by component. This features are returned during service discovery of a component.
