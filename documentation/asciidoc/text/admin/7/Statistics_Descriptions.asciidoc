...
It is a number of defined and active data sources (ie. connection pools). It is not a number of connections to data sources as it varies and is listed separately for every defined data source.
...
It is average time taken by call of {method} for this data source since creation of data source (most likely from server startup). It includes time taken by calls which thrown exception, etc.
