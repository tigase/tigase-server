...
include::text/admin/Quick_Start/Installing_Using_Console_Installer.asciidoc[]
...
include::text/admin/Configuration/init.properties_Configuration.asciidoc[]
...
include::text/admin/Database_Manegement/Database_Manegement.asciidoc
...
include::text/components/pubsub/documentation/text/Schema_Changes.asciidoc[]
