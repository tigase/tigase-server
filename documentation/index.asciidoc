...
include::text/components/http-api/documentation/HTTP_API_Component.asciidoc[]

include::text/components/http-api/documentation/HTTP_API_Component_modules.asciidoc[]

include::text/components/http-api/documentation/HTTP_Server.asciidoc[]

include::text/components/http-api/documentation/HTTP_File_Upload_Component.asciidoc[]

include::text/admin/Admin_Guide_56_-_Components_-_B_-_Tigase_HTTP_API_-_1_-_REST_API_Guide.asciidoc[]

include::text/HTTP_API_Usage_Examples.asciidoc[]
...
include::text/Pre-bind_Bosh.asciidoc[]
