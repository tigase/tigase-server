...
include::text/admin/HTTP_API_Usage_Examples.asciidoc[]
...
include::text/admin/Pre-bind_Bosh.asciidoc[]
...
include::text/admin/Configuration_of_statistics_loggers.asciidoc[]
