...
-- QUERY START:
IF EXISTS(SELECT * FROM sys.indexes WHERE object_id = object_id('schema.tig_pairs') AND NAME ='IX_clustered_tig_pairs_nid_uid_pkey')
    DROP INDEX IX_clustered_tig_pairs_nid_uid_pkey ON SCHEMA.tig_pairs;
-- QUERY END:
GO
