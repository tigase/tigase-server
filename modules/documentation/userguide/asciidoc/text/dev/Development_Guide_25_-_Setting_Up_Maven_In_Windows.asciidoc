...
Now click the image:images/dev/Env-button.jpg[Environment Variables] button at the bottom of the panel and the Environment Variables panel will show.
