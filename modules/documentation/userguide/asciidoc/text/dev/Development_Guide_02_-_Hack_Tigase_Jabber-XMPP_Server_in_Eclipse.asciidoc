...
image:images/dev/win-git1.jpg[]

Click next, and now select clone URI

image:images/dev/win-git2.jpg[]
...
image:images/dev/Eclipse-help.jpg[]
...
image:images/dev/Eclipse-m2Einstall.jpg[]
...
image:images/dev/Eclipse-importMaven.jpg[]
...
image:images/dev/Eclipse-importMaven2.jpg[]
