 ...
 * @version $Rev$
 */
public class WebSocketClientConnectionClustered extends WebSocketClientConnectionManager implements
		ClusteredComponentIfc {

	/**
	 * Variable <code>log</code> is a class logger.
	 */
	private static final Logger log = Logger.getLogger(WebSocketClientConnectionClustered.class
			.getName());
