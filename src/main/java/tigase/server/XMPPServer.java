...
//      }
	 ...
	 *
	 *
	 * @param args is a <code>String[]</code>
	 */
	 ...
	 *
	 * @return a value of <code>MessageReceiver</code>
	 */
	 ...
	 *
	 *
	 * @return a value of <code>ConfiguratorAbstract</code>
	 */
	...
	public static String getImplementationVersion(Class<?> c) {
		...
		String  version = (p == null)
				? null
				: p.getImplementationVersion();

		return ((title == null)
				? "unrecognized"
				: title) + " ver. " + ((version == null)
				? "unknown"
				: version);
	}
	 ...
	 *
	 *
	 * @param val is a <code>boolean</code>
	 */
