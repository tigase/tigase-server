...
public class Packet {
	 ...
	 *
	 *
	 *  <code>String</code> representation of the packet with all its fields.
	 *
	 ...
	 *
	 *  a new <code>Packet</code> instance with an error type stanza which
	 ...
	 *  a new <code>Packet</code> instance with an OK (result) type stanza
	 ...
	 *  a <code>Packet</code> instance, more specifically instance of one of the
	 ...
	 *
	 *  a new <code>Packet</code> instance with <code>route</code> stanza.
	 *
	 * @return a value of <code>Packet</code>
	 */
	 ...
	 *
	 *  a new packet instance with a copy of the stanza element with
	 ...
	 *
	 *  a new <code>Packet</code> instance.
	 *
	 * @return a value of <code>Packet</code>
	 */
	 ...
	 * (<code>false</code>).
	 *
	 *  a <code>String</code> representation of the packet instance.
	 *
	 * @return a value of <code>String</code>
	 */
...
//        + permissions;
	 ...
	 *
	 *
	 *  a new instance of the <code>Packet</code> class with unpacket
	 ...
	 *
	 *  a <code>boolean</code> value of <code>true</code> of the packet was
	 ...
	 *
	 *  CData for a given element or NULL if the element does not exist or there is
	 ...
	 *
	 *
	 *  CData or from the stanza top element or NULL if there is no CData for the
	 * element.
	 *
	 * @return a value of <code>String</code>
	 */
	 ...
	 * retrieved.
	 *
	 *  children list for a given element or NULL if the element does not exist
	 ...
	 *  a <code>String</code> representation of the stanza source address or NULL
	 ...
	 * Use of this method is not recommended, the API is depreciated in favor of API
	 * operating on <code>JID</code> class.
	 *  a <code>String</code> representation of the stanza destination address or
	 ...
	 * </pre>
	 *
	 *  a <code>JID</code> instance of the packet source address or NULL if
	 ...
	 *
	 *
	 *  a <code>JID>/code> instance of the packet internal source address or
	 ...
	 *
	 *
	 *  a <code>JID>/code> instance of the packet internal destination address or
	 ...
	 *
	 * @return a value of <code>Permissions</code>
	 */
	 ...
	 *  the packet priority.
	 *
	 * @return a value of <code>Priority</code>
	 */
	 ...
	 *
	 *
	 *  a <code>Set</code> of stanza processor IDs which handled the packet.
	 *
	 ...
	 *  a <code>JID</code> instance of the stanza source address or NULL if the
	 ...
	 *
	 *
	 *  a <code>String</code> representation of the stanza ID or NULL if the ID has
	 ...
	 *  a <code>JID</code> instance of the stanza destination address or NULL if
	 ...
	 * </pre>
	 *
	 *  a <code>JID</code> instance of the packet destination address or NULL if
	 ...
	 *
	 *
	 *  a <code>StanzaType</code> instance of the stanza type parsed from the
	 * top XML element of the enclosed stanza or NULL of the type has not been set.
	 *
	 * @return a value of <code>StanzaType</code>
	 */
	 ...
	 * </pre>
	 *
	 *  a <code>String</code> instance of the stanza top element XMLNS.
	 *
	 * @return a value of <code>String</code>
	 */
	 ...
	 *
	 *  a <code>boolean</code> value <code>true</code> if the stanza is
	 ...
	 *
	 *  a <code>boolean</code> value of <code>true</code> if the packet is
	 ...
	 *
	 *  a <code>true</code> is element given in parameters is found in the packet
	...
	private String calcToString(String elemData) {
		return ", DATA=" + elemData + ", SIZE=" + elem.toString().length() + ", XMLNS=" + elem
				.getXMLNS() + ", PRIORITY=" + priority + ", PERMISSION=" + permissions +
				", TYPE=" + type;
	}
	...
	private void setElem(Element elem) {
		...
		if (elem.getName() == "cluster") {
			...
			if ((elem.getName() == "presence") && ((type == null) || (type == StanzaType
					.available) || (type == StanzaType.unavailable) || (type == StanzaType
					.probe))) {
