...
public class TigaseAuth
	...
	private static final String USER_LOGIN_PLAIN_PW_QUERY =
	...
	public void addUser(BareJID user, final String password)
		...
		try {
			PreparedStatement add_user_plain_pw_sp = data_repo.getPreparedStatement(user,
					ADD_USER_PLAIN_PW_QUERY);
	...
	public void initRepository(final String connection_str, Map<String, String> params)
		...
		try {
			...
			data_repo.initPreparedStatement(USER_LOGIN_PLAIN_PW_QUERY,
					USER_LOGIN_PLAIN_PW_QUERY);
	...
	public void logout(BareJID user) throws UserNotFoundException, TigaseDBException {
		try {
			PreparedStatement user_logout_sp = data_repo.getPreparedStatement(user,
					USER_LOGOUT_QUERY);
	...
	public boolean plainAuth(BareJID user, final String password)
		...
		try {
			PreparedStatement user_login_plain_pw_sp = data_repo.getPreparedStatement(user,
					USER_LOGIN_PLAIN_PW_QUERY);
	...
	public void removeUser(BareJID user) throws UserNotFoundException, TigaseDBException {
		try {
			PreparedStatement remove_user_sp = data_repo.getPreparedStatement(user,
					REMOVE_USER_QUERY);
	...
	private String getPassword(BareJID user) throws SQLException, UserNotFoundException {
		...
		try {
			PreparedStatement get_pass_sp = data_repo.getPreparedStatement(user,
					GET_PASSWORD_QUERY);
