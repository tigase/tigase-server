...
public interface SSLContextContainerIfc {
	...
	/**
	 * Constant <code>SSL_CONTAINER_CLASS_KEY</code> is a key pointing to a container
	...
	/**
	 * Constant <code>ALLOW_SELF_SIGNED_CERTS_KEY</code> is a key pointing to
	 ...
	 * This should be really set to <code>false</code> in any real deployment
