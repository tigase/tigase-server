...
public class VHostItem
	...
	public void addCommandFields(Packet packet) {
		...
		Command.addFieldValue(packet, DOMAIN_FILTER_POLICY_LABEL, domainFilter.toString(), DOMAIN_FILTER_POLICY_LABEL,
							  DomainFilterPolicy.valuesStr(), DomainFilterPolicy.valuesStr());
