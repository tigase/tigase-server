 ...
 * @author andrzej
 */
public class Mobile extends XMPPProcessor implements XMPPProcessorIfc, XMPPPacketFilterIfc {
        ...
        private static final Element[] SUP_FEATURES = {
                new Element(MOBILE_EL_NAME, new String[]{"xmlns"},
                new String[]{XMLNS})};
...
//                                                && res.getElement().getChild("query", "http://jabber.org/protocol/disco#info") != null) {
//                                                
//                                                queue.offer(res);
//                                                it.remove();
//                                        }
