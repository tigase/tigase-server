...
You can have a look in the current build, with more complete test cases, file for link:https://github.com/tigase/tigase-testsuite/tree/master/tests/data/JabberIqPrivate.cot[JabberIqPrivate].
