...
You will see some information about our commercial products and licensing. Please read though the agreement, type in your name or company and click "Next" to go to the next page.
...
At the next page you will be presented with a list of possible connectivity options supported by Tigase XMPP Server and a way to enable/disable each of them. After making this decisions, click "Next".

Now you will be able to select which features of Tigase XMPP Server (such as MUC, PubSub, MIX, MAM, Push Notifications) should be enabled or disabled. When you will be ready, click "Next".
...
The installation is almost complete and you will be presented with a page showing what the `config.tdsl` file will look like.
