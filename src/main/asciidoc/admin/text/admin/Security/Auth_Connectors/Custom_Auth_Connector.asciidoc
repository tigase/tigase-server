...
-----
NOTE: `online_status` column does not exist and would need to be added for that query to work.
...
-----
NOTE: `TigUserLoginPlainPw` is no longer part of a Tigase XMPP Server database schema and would need to be created.
